...
class AdvCandleStickChart extends Pane {
    ...
    public AdvCandleStickChart() {
        ...
        // x-axis:
        NumberAxis xAxis = new NumberAxis(0, data.length + 1 , 1);
        ...
        // chart:
        CandleStickChart bc = new CandleStickChart(xAxis, yAxis);
                ...
                while (iter.hasNext()) {
                    ...
                    if (itemNode instanceof Candle && extra != null) {
                        ...
                        if (getXAxis() instanceof NumberAxis) {
                            ...
                            candleWidth = xa.getDisplayPosition(xa.getTickUnit()) * 0.85; // use 90% width between ticks
                        }
                        // update candle
                    ...
                    if (seriesPath != null && !Double.isNaN(extra.getAverage())) {
 ...
 */
public class SampleAdvCandleStickChart extends Application {

    @Override
    public void start(Stage stage) {
        stage.setTitle("AdvCandleStickChart from Ensemble");
        AdvCandleStickChart candleStickChart = new AdvCandleStickChart();
        
        Scene scene = new Scene(candleStickChart, 800, 600);
